...
tracked in the manager-decision file (`{memory_root}/manager-decision.md` — the per-root
record; C2 config records who that is). Until then this is the team standard candidate.
